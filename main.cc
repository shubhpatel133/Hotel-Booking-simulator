...
int main()
{
    ...
    while (choice != 0 && cin.good())
    {
        ...
        std::cout << " 10. [22 marks + 1 Bonus] Test all and get mark" << endl
                  << endl;
        cin >> choice;
        std::cout << endl;
        switch (choice)
        ...
        case 10:
            ...
            std::cout << "Your score is " << score << " out of 22" << endl
                      << endl;
            break;
        }
    }
...
int testResOverlap()
{
    int score = 2;
    std::cout << endl
              << "Testing Reservation overlap function..." << endl;
...
{
    std::cout << endl
              << "Testing room isMatch function..." << endl
              << endl;
...
{
    std::cout << endl
              << "Testing Hotel addRoom function..." << endl
              << endl;
...
{
    std::cout << endl
              << "Testing Hotel addRoom function for correct order..." << endl
              << endl;
...
{
    std::cout << endl
              << "Testing Hotel deleteRoom function..." << endl
              << endl;
...
{
    std::cout << endl
              << "Testing room add reservation function..." << endl
              << endl;
    ...
    std::cout << "All names found, 2 marks" << endl
              << endl;
    score += SCORE;
...
{
    std::cout << endl
              << "Testing room add reservation function for correct order..." << endl
              << endl;
    ...
    std::cout << "All names found in order, 2 marks" << endl
              << endl;
    return SCORE;
}
...
{
    std::cout << endl
              << "Testing Hotel add reservation function..." << endl
              << endl;
...
{
    std::cout << endl
              << "Testing Hotel update reservation function..." << endl
              << endl;
